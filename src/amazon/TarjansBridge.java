...
// It uses SCCUtil()
    ...
    public static void main(String args[]) {
        ...
        TarjansBridge g1 = new TarjansBridge(5);
        ...
        TarjansBridge g2 = new TarjansBridge(4);
        g2.addEdge(0, 1);
        g2.addEdge(1, 2);
        g2.addEdge(2, 3);
        System.out.println("\nSSC in second graph ");
        ...
        TarjansBridge g3 = new TarjansBridge(7);
        g3.addEdge(0, 1);
        g3.addEdge(1, 2);
        g3.addEdge(2, 0);
        g3.addEdge(1, 3);
        ...
        TarjansBridge g4 = new TarjansBridge(11);
        g4.addEdge(0, 1);
        g4.addEdge(0, 3);
        g4.addEdge(1, 2);
        g4.addEdge(1, 4);
        ...
        TarjansBridge g5 = new TarjansBridge(5);
        g5.addEdge(0, 1);
        g5.addEdge(1, 2);
        g5.addEdge(2, 3);
        g5.addEdge(2, 4);
