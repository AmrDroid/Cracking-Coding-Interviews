...
public class PatternSearchingTrieSuffix {
    final static int MAX_CHAR = 256;

    PatternSearchingTrieSuffix[] children = new PatternSearchingTrieSuffix[MAX_CHAR];
    List<Integer> indexes;

    PatternSearchingTrieSuffix() // Constructor
    {
    ...
    void insertSuffix(String s, int index) {
        ...
        if (s.length() > 0) {
            ...
            if (children[cIndex] == null)
                children[cIndex] = new PatternSearchingTrieSuffix();
...
class Suffix_tree{
    ...
    PatternSearchingTrieSuffix root = new PatternSearchingTrieSuffix();
