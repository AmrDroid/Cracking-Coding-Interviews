...
class MergeBST {
    ...
    public ArrayList<Integer> storeInorderUtil(Node5 node, ArrayList<Integer> list) {
        if (node == null)
            return list;
    ...
    ArrayList<Integer> storeInorder(Node5 node) {
    ...
    Node5 ALtoBST(ArrayList<Integer> list, int start, int end) {
        // Base case
        if (start > end)
            return null;
        ...
        int mid = (start + end) / 2;
        Node5 node = new Node5(list.get(mid));
    ...
    Node5 mergeTrees(Node5 node1, Node5 node2) {
        ...
        Node5 node = ALtoBST(list3, 0, list3.size() - 1);
        return node;
    }
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        tree1.root = new Node5(100);
        tree1.root.left = new Node5(50);
        tree1.root.right = new Node5(300);
        tree1.root.left.left = new Node5(20);
        tree1.root.left.right = new Node5(70);
        ...
        */
        ...
        tree2.root = new Node5(80);
        tree2.root.left = new Node5(40);
        tree2.root.right = new Node5(120);
