...
public class SortlinkedListWhichAlreadySortedOnAbsoluteValues
{
    ...
    {
        SortlinkedListWhichAlreadySortedOnAbsoluteValues llist = new SortlinkedListWhichAlreadySortedOnAbsoluteValues();
