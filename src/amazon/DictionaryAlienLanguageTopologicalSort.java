...
public class DictionaryAlienLanguageTopologicalSort {

    // An array representing the graph as an adjacency list
    private final LinkedList<Integer>[] adjacencyList;

    DictionaryAlienLanguageTopologicalSort(int nVertices)
    {
 ...
 class OrderOfCharacters
{
    ...
    private static void printOrder(String[] words, int alpha)
    {
        ...
        DictionaryAlienLanguageTopologicalSort graph = new DictionaryAlienLanguageTopologicalSort(alpha);
