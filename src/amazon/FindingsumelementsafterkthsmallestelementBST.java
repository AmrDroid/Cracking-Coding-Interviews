...
public class FindingsumelementsafterkthsmallestelementBST {
    Node root;
    ...
    public static void main(String[] args) {
        FindingsumelementsafterkthsmallestelementBST tree = new FindingsumelementsafterkthsmallestelementBST();
        tree.insert(20);
        tree.insert(15);
        tree.insert(25);
        tree.insert(10);
