...
class nTreeNode {
    ...
    public nTreeNode left()  { return left; }
    public nTreeNode right() { return right; }
    ...
    public void setLeft(nTreeNode left)   { this.left = left; }
    public void setRight(nTreeNode right) { this.right = right; }
}
...
class VerticalSumTree {
    ...
    // Constructors
    public VerticalSumTree() { root = null; }
    public VerticalSumTree(nTreeNode n) { root = n; }
    ...
    private void VerticalSum(nTreeNode root) {
    ...
    private void VerticalSumUtil(nTreeNode root, int hD,
                                 TreeMap<Integer, Integer> hM) {
