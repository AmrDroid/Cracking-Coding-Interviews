...
import java.io.*;
import java.util.*;
public class ImplementingChecksumUsing {
    ...
    public ImplementingChecksumUsing(InetAddress ip,int port)throws IOException
    {
    ...
    public static void main(String args[])throws IOException
    {
        ...
        ImplementingChecksumUsing cr = new ImplementingChecksumUsing(ip,5000);
    }
